            ...
            <div class="box box-primary">
                ...
                <div class="box-body bg-info text-center">
                    <div class="alert alert-info alert-dismissible text-left">
                        ...
                        <h4><i class="icon fa fa-check"></i> 更新内容 2018-1-21 17:30</h4>
                        1、角色授权（列表-树行）；&nbsp; 2、列表自定义列；&nbsp;3、支持三级菜单； &nbsp;4、数据权限；&nbsp;5、弹窗垂直居中； &nbsp;6、C3P0改为Druid；&nbsp;
                    </div>
                    <div class="row">
                        <div class="col-md-6 text-right">
                            <img src="${basePath}/resources/common/images/admineap.png" width="80px" height="80px"
                                 alt="AdminEAP"/>
                        </div>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/generator/setting">
                        ...
                        <div class="clearfix visible-sm-block"></div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/job/list">
                        ...
                        <!-- /.col -->
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/message/list">
        ...
        <div class="col-md-12">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/activiti/model/list">
                                <span class="info-box-icon bg-yellow"><i class="fa fa-edit"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text text-blod">Workflow Model</span>
                                    <span class="info-box-text">
                                        工作流模型
                                    </span>
                                    <span class="info-box-text-sm">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/activiti/processdef/list">
                                <span class="info-box-icon bg-yellow" ><i class="fa fa-edit"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text text-blod">Workflow Instance</span>
                                    <span class="info-box-text">
                                        工作流实例
                                    </span>
                                    <span class="info-box-text-sm">
                        ...
                        <div class="clearfix visible-sm-block"></div>
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/activiti/task/todo/list">
                                <span class="info-box-icon bg-yellow"><i class="fa fa-edit"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text text-blod">Workflow Task</span>
                                    <span class="info-box-text">
                                        我的待办
                                    </span>
                                    <span class="info-box-text-sm">
                        ...
                        <!-- /.col -->
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/activiti/delegate/mine">
                                <span class="info-box-icon bg-yellow"><i class="fa fa-edit"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text text-blod">Workflow Delegate</span>
                                    <span class="info-box-text">
											工作流委托
										</span>
                                    <span class="info-box-text-sm">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="info-box" data-url="/markdown/preview/csrf">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-box" data-flag="github" data-url="http://">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text-sm">遵循和使用MIT License 开源协议。</span>
                                    <span  class="info-box-text">
                                    ...
                                    <span class="info-box-text">
                                        <a class="btn btn-danger" href="https://github.com/bill1012/Java-AdminLTE"><i class="fa fa-lg fa-github"></i>&nbsp;Github地址</a>
                                        <a class="btn btn-danger" href="https://github.com/bill1012/Java-AdminLTE/archive/master.zip"><i class="fa fa-lg fa-github"></i>&nbsp;Github下载源码</a>
                                        <a class="btn btn-danger" href="https://github.com/bill1012/Java-AdminLTE/issues/new"><i class="fa fa-lg fa-github"></i>&nbsp;提交Bug或建议</a>
                                    </span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            ...
                            <div class="info-box" data-flag="contact">
                                ...
                                <div class="info-box-content">
                                    <span class="progress-description">
                                        <i class="fa fa-envelope"></i>&nbsp; ：admin@admineap.com
                                    </span>
                                    <span class="progress-description">
                                        <i class="fa fa-wechat"></i>&nbsp;：jrn1012
                                    </span>
                                    <span class="progress-description">
                                        <i class="fa fa-qq"></i>&nbsp; ：346837703(群)
                                    </span>
                                    <span class="progress-description">
